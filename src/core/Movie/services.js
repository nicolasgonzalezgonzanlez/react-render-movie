...
export const getGenres = () => axios.get(`${url}genre/movie/list${apiKey}`);
...
//trae una lista de peliculas similares
export const getRecommen = (idPelicula) => axios.get(`${url}movie/${idPelicula}/recommendations${apiKey}`);
